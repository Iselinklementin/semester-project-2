// sjekk global, tror ikke den er koblet opp
...
// forms edit / add
export const featuredCheckbox = document.querySelector(".featured");
export const nutrition = document.querySelector(".nutrition");
...
export const form = document.querySelector(".forms");
